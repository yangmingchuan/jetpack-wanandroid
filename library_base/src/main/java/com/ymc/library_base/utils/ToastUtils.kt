package com.ymc.library_base.utils
...
import com.ymc.library_base.AppGlobals
...
object ToastUtils : Serializable {
    ...
    private val context = AppGlobals.application
    ...
    fun custom(
        message: String, @DrawableRes iconRes: Int,
        @ColorInt textColor: Int, @DrawableRes bgRes: Int, duration: Int
    ): Toast? {
